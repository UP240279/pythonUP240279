...
# Programa 1 Encuentra la longitud del set itCompanies
print("Programa 1")
print("Longitud:" , len(itCompanies))

# Programa 2 Añade 'Twitter' a itCompanies
print("Programa 2")
itCompanies.add("Twitter")
print(itCompanies)

# Programa 3 Insertar varias empresas de TI a la vez en el set itCompanies
print("Programa 3")
itCompanies.update(["Intel", "Tesla", "Samsung", "Adobe"])
print(itCompanies)

#Programa 4 Eliminar una de las empresas del set itCompanies
print("Programa 4")
itCompanies.remove("Apple")
print(itCompanies)

# Programa 5 ¿Cuál es la diferencia entre eliminar y descartar? (remove y discard)
print("Programa 5")
