...
# Programa 1 
# Convierte las edades en un set y compara la longitud de la lista y el set, ¿cuál es más grande?
print("Programa 1")
ages = set(age)
print(ages)
...
# Programa 3 
# ¿Cuántas palabras únicas se han usado en la oración? Usa los métodos de split y set para obtener las palabras únicas.
print("Programa 3")
