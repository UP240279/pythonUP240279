...
# Programa 1 Unir A y B
print("Programa 1")
union = A.union(B)
print(union)

# Programa 2 Encuentra la intersección de A y B
print("Programa 2")
intersection = A.intersection(B)
print(intersection)

# Programa 3 Es A un subset de B
print("Programa 3")
subset = A.issubset(B)
print(subset)

# Programa 4 ¿Son A y B sets disjuntos?
print("Programa 4")
...
# Programa 7 Eliminar los sets por completo
print("Programa 7")
del A
del B
