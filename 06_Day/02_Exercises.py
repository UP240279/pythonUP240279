...
# Programa 1 
# Desempaquetar a hermanos y padres de familyMembers
print("Programa 1")
...
# Programa 2 
# Crea tuplas de frutas, verduras y productos animales. Une las tres tuplas y asígnalas a una variable llamada foodStuffTp
print("Programa 2")
...
# Programa 3 
# Cambie la tupla de foodStuffTp a una lista foodStuffLt
print("Programa 3")
foodStuffLt = list(foodStuffTp)
print(foodStuffLt)

# Programa 4 
# Extraiga el elemento o los elementos del medio de la tupla foodStuffTp o de la lista foodStuffLt
print("Programa 4")
print(len(foodStuffLt))
print(foodStuffLt[5],",", foodStuffLt[6])

# Programa 5 
# Separe los primeros tres elementos y los últimos tres elementos de la lista foodStuffLt
print("Programa 5")
...
# Programa 6 
# Eliminar la tupla foodStuffTp por completo
print("Programa 6")
del(foodStuffTp)
...
# Programa 7.2 
# Comprueba si 'Iceland' es un país nórdico
print("Programa 7.2")
