...
# Programa 2 Crea una tupla que contenga los nombres de tus hermanas y tus hermanos
print("Programa 2")
...
# Programa 3 Unir tuplas de hermanos y hermanas y asignarlas a hermanos
print("Programa 3")
siblings = brothers + sisters
print(siblings)

# Programa 4 ¿Cuántos hermanos tienes?
print("Programa 4")
